      ...
      <section>
        <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-12 px-6 py-16 sm:px-10 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <ul className="mt-8 space-y-5 text-body-lg">
      ...
      <section>
        <div className="mx-auto max-w-[1280px] px-6 py-16 sm:px-10">
          <div className="flex items-end justify-between gap-6">
            ...
            <Link
              to="/events"
              className="hidden shrink-0 label text-fg-muted transition hover:text-cyan sm:inline"
            >
              See all events →
            </Link>
          </div>
    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:gap-8">
      ...
      <div className="lg:col-span-2 lg:text-right">
        ...
        {gated ? (
          <Link
            to="/plus"
            className="mt-3 button-text inline-flex items-center gap-2 border border-rule-strong px-3 py-1.5 font-display font-bold text-fg-strong transition hover:border-cyan hover:text-cyan focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan"
          >
            Join to attend →
          </Link>
        ) : (

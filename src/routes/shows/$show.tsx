...
// Redirect: /shows/$show → /podcasts/$show. `inside-call-me-back` (Call Me Back
// Ark+) lives under /plus, so it gets its own destination. Every other slug is forwarded to
